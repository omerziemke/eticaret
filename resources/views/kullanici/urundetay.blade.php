            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                ...
                <div class="ps-product__image">
                  ...
                  <div class="item"><img class="zoom" src="{{asset('images/shoe-detail/2.jpg')}}" alt="" data-zoom-image="{{asset('images/shoe-detail/2.jpg')}}"></div>
              ...
              <div class="ps-product__thumbnail--mobile">
                ...
                <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="3" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img src="{{asset('images/shoe-detail/1.jpg')}}" alt=""><img src="{{asset('images/shoe-detail/2.jpg')}}" alt=""><img src="{{asset('images/shoe-detail/3.jpg')}}" alt=""></div>
              </div>
              <div class="ps-product__info">
                ...
                <div class="ps-product__block ps-product__style">
                  ...
                  <ul>
                    <li><a href="product-detail.html"><img src="{{asset('images/shoe-detail/3.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('images/shoe-detail/2.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('images/shoe-detail/2.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('images/shoe-detail/3.jpg')}}" alt=""></a></li>
                  </ul>
                </div>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail"><img src="{{asset('images/shoe-detail/1.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('images/shoe-detail/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('images/shoe-detail/32.jpg')}}" alt=""><img src="{{asset('images/shoe-detail/3.jpg')}}" alt=""><img src="{{asset('images/shoe-detail/4.jpg')}}" alt=""><img src="{{asset('images/shoe-detail/5.jpg')}}" alt=""></div>
